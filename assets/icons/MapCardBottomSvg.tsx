...
const MapCardBottomSvg = (props: ISvgProps) => (
  <Svg
    ...
    fill='none'
    {...props}>
    <Mask id='a' width={369} height={40} x={0} y={0} maskUnits='userSpaceOnUse'>
      <Path fill='#000' d='M0 0h369v40H0z' />
    </Mask>
    <Mask id='b' fill='#FFF'>
      <Path
        fillRule='evenodd'
